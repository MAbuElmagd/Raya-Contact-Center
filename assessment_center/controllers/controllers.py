...
class Survey(http.Controller):
    ...
    def survey_start(self, survey_token, answer_token=None, email=False, **post):
        ...
        if post.get('ass_id') != None:
            return request.redirect('/survey/%s/%s?ass_id=%s' % (survey_sudo.access_token, answer_sudo.access_token, post.get('ass_id')))
        elif post.get('app_id') != None:
            return request.redirect('/survey/%s/%s?app_id=%s' % (survey_sudo.access_token, answer_sudo.access_token, post.get('app_id')))
        else:
