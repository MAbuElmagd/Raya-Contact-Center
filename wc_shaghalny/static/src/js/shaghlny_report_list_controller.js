odoo.define('wc_shaghalny.ShaghalnyReportListController', function (require) {
"use strict";
...
var ShaghalnyReportListController = ListController.extend({
    ...
    renderButtons: function ($node) {
        ...
        var $button = $(qweb.render('ShaghalnyReport.Buttons'));
    ...
    _onOpenView: function () {
        ...
        var self = this
        this._rpc({
            model: 'wc.applicant.shaghlny',
            method: 'action_view_summary',
            args: [[]],
...
return ShaghalnyReportListController;
